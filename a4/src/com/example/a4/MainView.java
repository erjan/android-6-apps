...
public class MainView extends View implements Observer {
    ...
    MainView(Context context, Model m) {
        ...
        Fruit one = new Fruit(new float[] {10, 10, 100,10, 100, 100, 10,100} ) ;
        one.translate(300, 300);
        model.add(one);
        
        
        //Fruit f2 = new Fruit(new float[] {0, 20, 20, 0, 40, 0, 60, 20, 60, 40, 40, 60, 80, 60, 0, 40});
                        ...
                        while(i.hasNext()) {
                            ...
                            if (s.intersects(drag.getStart(), drag.getEnd())) {
                                ...
                                try {
                                    ...
                                    // TODO BEGIN CS349
                                    // you may want to place the fruit 
                                    //more carefully than this
                                    newFruits[0].translate(50, -10);
                                    newFruits[1].translate(50, +10);
                                    // TODO END CS349
    ...
    class MouseDrag {
        ...
        public PointF getStart() { return new PointF(startx, starty); }
        public PointF getEnd() { return new PointF(endx, endy); }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawLine( drag.getStart().x , drag.getStart().y ,
        		         drag.getEnd().x , drag.getEnd().y  , new Paint()) ;
    }
